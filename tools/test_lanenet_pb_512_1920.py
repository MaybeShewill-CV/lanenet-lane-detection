...
def test_lanenet(image_path, weights_path):
    ...
    # binary_seg_ret = 'final_binary_output:0'
    # instance_seg_ret = 'final_pixel_embedding_output:0'
    with tf.gfile.GFile(weights_path, 'rb') as file_handle:
    ...
    with sess.as_default():
        ...
        plt.show()
        '''
        lane_idx = np.where(binary_seg_image==1)
        arrow_idx = np.where(binary_seg_image==2)
        ...
        cv2.imwrite('binary_mask_image.png', binary_seg_image * 30)
